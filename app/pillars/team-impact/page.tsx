...
export const metadata: Metadata = {
  title: "Team Impact | D1 Frontline Leadership",
  description:
    "Learn how to identify team impact before hiring — the ability to elevate the performance, accountability, and success of those around you.",
};

const interviewQuestions = [
  "Tell me about a time you helped someone succeed.",
  "Describe a team you improved.",
  "What would former team members say about working with you?",
  "How do you handle poor performance on a team?",
];
...
const redFlags = [
  "Focuses only on personal accomplishments",
  "Struggles to develop others",
  "Creates conflict unnecessarily",
  "Takes credit for team successes",
  "Has difficulty describing positive impact on others",
];
      ...
      <main>
        <section className="relative overflow-hidden pt-28 pb-16 lg:pt-36 lg:pb-20">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            <PillarPageNav pillarLabel="Team Impact" />
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg leading-relaxed text-white/65 lg:text-xl">
                The ability to elevate the performance, accountability, and
        ...
        <div className="mx-auto max-w-3xl px-6 pb-24 lg:px-8 lg:pb-32">
          <section className="mb-16">
            ...
            <p className="mt-4 text-lg leading-relaxed text-white/65">
              Team Impact measures whether a person improves the people around
              them. Great leaders create positive influence that extends beyond
          ...
          <section className="mb-16">
            ...
            <p className="mt-4 text-lg leading-relaxed text-white/65">
              Organizations do not scale through individual contributors alone.
              Leaders create results through teams. Team Impact focuses on
              multiplying performance rather than simply producing it personally.
            </p>
          </section>

          <section className="mb-16">
            <h2 className="font-display text-2xl font-bold sm:text-3xl">
              How to Identify Team Impact Before Hiring
            </h2>
            <div className="mt-6 rounded-sm border border-gold-500/25 bg-gradient-to-br from-gold-500/8 via-navy-800/80 to-navy-900/90 p-6 sm:p-8">
              <p className="text-lg leading-relaxed text-white/75">
                Strong leaders leave evidence of improved teams, stronger
                cultures, and better results. Use these interview questions to
                uncover whether candidates elevate others or focus only on
                themselves.
              </p>
            </div>
          ...
          <section className="mb-16">
            ...
            <p className="mt-4 text-lg leading-relaxed text-white/65">
              Elite athletes understand that individual talent wins games, but
              strong teams win championships. The best leaders elevate everyone
              around them.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <p className="mt-4 text-lg leading-relaxed text-white/65">
              In operations environments, Team Impact appears when leaders
              improve engagement, reduce turnover, strengthen accountability,
              develop future leaders, and create high-performing teams.
            </p>
          </section>

          <section className="mb-16">
            <h2 className="font-display text-2xl font-bold sm:text-3xl">
              Individual Performance vs Team Impact
            </h2>
            <p className="mt-4 text-lg leading-relaxed text-white/65">
              Many people produce results. Great leaders create environments
              where others produce results as well.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <blockquote className="mt-6 rounded-sm border border-gold-500/30 bg-gold-500/5 px-6 py-8 sm:px-8">
              <p className="font-display text-lg font-semibold leading-relaxed text-white/90 sm:text-xl">
                The true measure of leadership is not what you accomplish alone,
                but what happens because you were there.
              </p>
            </blockquote>
          </section>
          ...
          <div className="text-center">
            <Link
              href="/free-framework"
              data-track="team_impact_free_framework_cta"
