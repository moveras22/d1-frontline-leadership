...
import { SUPERVISOR_INTERVIEW_SCORECARD } from "@/lib/resources/downloads";

const resource = SUPERVISOR_INTERVIEW_SCORECARD;
...
export default function SupervisorInterviewScorecardPage() {
  return (
    <>
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl rounded-sm border border-white/10 bg-navy-800/50 p-8 sm:p-10">
              ...
              <p className="mt-4 text-white/60">
                Everything you need to run consistent, evidence-based supervisor
                interviews on the plant floor.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-6 pt-24 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-white/60">
                Get the Supervisor Interview Scorecard instantly — no email
                required.
              </p>
              <a
                href={resource.pdfUrl}
                download={resource.pdfDownloadName}
                data-track="supervisor_interview_scorecard_download"
