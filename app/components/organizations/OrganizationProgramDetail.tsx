...
import type { OrganizationProgram } from "@/lib/organizations";

type OrganizationProgramDetailProps = {
  program: OrganizationProgram;
};

export default function OrganizationProgramDetail({
  program,
}: OrganizationProgramDetailProps) {
  return (
    <>
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl rounded-sm border border-gold-500/20 bg-gold-500/5 p-8 text-center sm:p-10">
              ...
              <p className="mt-4 text-base leading-relaxed text-white/60">
                Explore the D1 Framework and free resources to start improving
                how your organization hires, promotes, and develops frontline
                leaders.
              </p>
